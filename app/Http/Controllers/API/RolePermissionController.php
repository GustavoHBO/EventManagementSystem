...
class RolePermissionController extends Controller
{
    ...
    {
        BaseBusiness::hasPermissionTo('view roles');
        $roles = Role::all();
    ...
    public function createRole(Request $request): JsonResponse
    {
        ...
        return $this->sendSuccessResponse($role, 'Role criado com sucesso!');
    }
    ...
    {
        BaseBusiness::hasPermissionTo('delete roles');
    ...
    {
        BaseBusiness::hasPermissionTo('view permissions');
    ...
    {
        $permission = RolePermissionBusiness::createPermission($request->all());
        return $this->sendSuccessResponse($permission, 'Permission criado com sucesso!');
    }
    ...
    {
        BaseBusiness::hasPermissionTo('delete permissions');
